...
def graph_from_line(l, G=None, colors=[]):
  ...
  G.add_edge(f"{ng}_M2", f"{ng}_M4", dx=0, dy=1, dz=0, distance=np.round(distMM(2,4,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M6", f"{ng}_M8", dx=0, dy=1, dz=0, distance=np.round(distMM(6,8,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M1", f"{ng}_M3", dx=0, dy=1, dz=0, distance=np.round(distMM(1,3,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M5", f"{ng}_M7", dx=0, dy=1, dz=0, distance=np.round(distMM(5,7,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M2", f"{ng}_M6", dx=1, dy=0, dz=0, distance=np.round(distMM(2,6,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M4", f"{ng}_M8", dx=1, dy=0, dz=0, distance=np.round(distMM(4,8,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M3", f"{ng}_M7", dx=1, dy=0, dz=0, distance=np.round(distMM(3,7,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M1", f"{ng}_M5", dx=1, dy=0, dz=0, distance=np.round(distMM(1,5,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M1", f"{ng}_M2", dx=0, dy=0, dz=1, distance=np.round(distMM(1,2,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M3", f"{ng}_M4", dx=0, dy=0, dz=1, distance=np.round(distMM(3,4,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M5", f"{ng}_M6", dx=0, dy=0, dz=1, distance=np.round(distMM(5,6,l["a"],l["b"],l["c"]), 3))
  G.add_edge(f"{ng}_M7", f"{ng}_M8", dx=0, dy=0, dz=1, distance=np.round(distMM(7,8,l["a"],l["b"],l["c"]), 3))
  return G, colors
...
if __name__ == "__main__":
    ...
    # print(from_networkx(G).edge_index)
    # sys.exit(0)
